        ...
        return (
            <Card className="text-center">
                ...
                {this.props.shirt.text ?
                    <div ref="text" className="shirt-text-final" style={{ color: this.props.shirt.textColor.color, fontFamily: this.props.shirt.font, left: "115px", top: "80px", fontSize: "20px" }}>{this.props.shirt.text}</div> : null}
